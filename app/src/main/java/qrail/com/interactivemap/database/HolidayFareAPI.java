...
public class HolidayFareAPI extends ParentAPI {

    public static final String TABLE_NAME = "FareTableHoliday";
    //    public static final String TABLE_NAME = "NewMetroHolidayFare";
